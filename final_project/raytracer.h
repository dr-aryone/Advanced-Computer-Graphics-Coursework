...
public:
  ...
  bool CastRayWithBackfacing(const Ray &ray, Hit &h, bool use_rasterized_patches) const;
  
  // does the recursive work
  Vec3f TraceRay(Ray &ray, Hit &hit, int bounce_count = 0, double refractive_index = 1.0) const;
